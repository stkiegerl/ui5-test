			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5test-display": {
								"semanticObject": "ui5test",
								"action": "display",
								"description": "Dockerized Fiori application Test",
								"title": "UI5-test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5test",
									"url": sap.ui.require.toUrl("ui5test")
								}
							}
						}
					}
